    ...
    return (
      <div className="group relative mb-8">
        ...
        <button
          ...
          className="absolute top-0 right-0 opacity-60 sm:opacity-0 sm:group-hover:opacity-60 hover:!opacity-100 focus-visible:opacity-100 transition-opacity p-1 text-ink-soft"
        >
