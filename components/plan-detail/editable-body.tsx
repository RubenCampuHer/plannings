    ...
    return (
      <div className="group relative">
        <button
          ...
          className="absolute top-0 right-0 opacity-0 group-hover:opacity-60 hover:!opacity-100 focus-visible:opacity-100 transition-opacity p-1 text-ink-soft z-10"
        >
